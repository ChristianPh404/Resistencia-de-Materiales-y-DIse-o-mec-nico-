...
\usepackage{pdflscape}  % permite páginas horizontales que se ven rotadas en el PDF
...
\title{\Huge{Resistencia de Materiales y Diseño Mecánico}\\Apuntes}
...
\include{Capitulos/Tema1}

% ! \graphicspath{ {./Imagenes/} } poner eso para que las imagenes carguen correctamente en preamble.tex
